...
var descriptionsvue_type_template_id_0c9eac7b_scoped_true_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
...
var descriptions_rowvue_type_template_id_b0a06cc8_scoped_true_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('tbody', [_vm.wDescriptions.direction === 'vertical' ? [_c('tr', {
  ...
  }), 0)] : _vm.wDescriptions.border ? void 0 : [_c('tr', {
    staticClass: "w-descriptions-row"
  }, _vm._l(_vm.processedRow, function (rowItem, index) {
    return _c('td', {
      key: index,
...
// 组件列表
const components = [src_button, svg_icon, divider, card, descriptions, descriptions_item];
