  ...
  return (function () {
    var t = {
          ...
          (function (e, n) {
            ...
            var o = i(function (t, e) {
                (function (e, n) {
                  ...
                  function n(n, i) {
                    var o = i && !0 === i.clone;
                    return o && t(n) ? r(e(n), n, i) : n;
                  }
                  function i(e, i, o) {
                    var C = e.slice();
                    return (
                      i.forEach(function (i, l) {
                        "undefined" === typeof C[l]
                          ? (C[l] = n(i, o))
                          : t(i)
                          ? (C[l] = r(e[l], i, o))
                          : -1 === e.indexOf(i) && C.push(n(i, o));
                      }),
                      C
                    );
                  }
        ...
        5042: function (t, e, n) {
          (function (e, n) {
            ...
            function O(t, e) {
              var n = g(t).reduce(function (t, n) {
                if (!n.attributes) return t;
                var i = g(n.attributes),
                  o = e ? i.filter(e) : i;
                return t.concat(o);
              }, []);
              return n;
            ...
            var T,
              ...
              I = function (t, e, n, i) {
                ...
                l.forEach(function (t) {
                  return (t.value = t.value.replace(new RegExp(B(o), "g"), r));
                }),
                  Z(e, o, r);
              },
              ...
              z = (function (t) {
                function n(n) {
                  var o = this;
                  void 0 === n && (n = {}), t.call(this, e(v, n));
                  var r = i();
                  (this._emitter = r), (this.node = null);
                  var C = this,
                    l = C.config;
                  if (
                    (l.autoConfigure && this._autoConfigure(n),
                  ...
                  (this._handleLocationChange = s),
                    l.listenLocationChangeEvent &&
                      window.addEventListener(l.locationChangeEvent, s),
                    l.locationChangeAngularEmitter && M(l.locationChangeEvent),
                    r.on($.MOUNT, function (t) {
                      l.moveGradientsOutsideSymbol && S(t);
                    }),
                    r.on($.SYMBOL_MOUNT, function (t) {
                      l.moveGradientsOutsideSymbol && S(t.parentNode),
                        (m.isIE() || m.isEdge()) && x(t);
                    });
                }
                t && (n.__proto__ = t),
                ...
                return (
                  ...
                  (n.prototype._autoConfigure = function (t) {
                    ...
                    "undefined" === typeof t.syncUrlsWithBaseTag &&
                      ...
                      "undefined" === typeof t.moveGradientsOutsideSymbol &&
                        (n.moveGradientsOutsideSymbol = m.isFirefox());
                  }),
                  ...
                  (n.prototype.attach = function (t) {
                    ...
                    return (
                      ...
                      g(i.querySelectorAll("symbol")).forEach(function (t) {
                        var e = h.createFromExistingNode(t);
                        (e.node = t), n.add(e);
                      }),
                      this._emitter.emit($.MOUNT, i),
                      i
                    );
                  }),
                  (n.prototype.destroy = function () {
                  ...
                  (n.prototype.updateUrls = function (t, e) {
                    ...
                    return I(this.node, n, _(t) + "#", _(e) + "#"), !0;
                  }),
            ...
            F
              ? (T = window[U])
              : ((T = new z({ attrs: { id: D, "aria-hidden": "true" } })),
                (window[U] = T));
            var W = function () {
        ...
        7740: function (t, e, n) {
          ...
          t.exports = function (t, e, n) {
            for (var l = o(e), c = C.f, s = r.f, u = 0; u < l.length; u++) {
              var a = l[u];
              i(t, a) || (n && i(n, a)) || c(t, a, s(e, a));
            }
          };
        },
        2211: function (t, e, n) {
        ...
        6840: function (t, e, n) {
          ...
          t.exports = function (t, e, n, l) {
            l || (l = {});
            var c = l.enumerable,
              s = void 0 !== l.name ? l.name : e;
            if ((i(n) && r(n, s, l), l.global)) c ? (t[e] = n) : C(e, n);
            else {
              try {
                l.unsafe ? t[e] && (c = !0) : delete t[e];
              } catch (u) {}
              c
                ? (t[e] = n)
                : o.f(t, e, {
        ...
        4055: function (t, e, n) {
          ...
          var i = n(4576),
            o = n(34),
            r = i.document,
            C = o(r) && o(r.createElement);
          t.exports = function (t) {
            return C ? r.createElement(t) : {};
          };
        },
        6837: function (t) {
          "use strict";
        ...
        9519: function (t, e, n) {
          ...
          u &&
            ((i = u.split(".")),
            (o = i[0] > 0 && i[0] < 4 ? 1 : +(i[0] + i[1]))),
            !o &&
              C &&
              ((i = C.match(/Edge\/(\d+)/)),
              (!i || i[1] >= 74) &&
                ((i = C.match(/Chrome\/(\d+)/)), i && (o = +i[1]))),
            (t.exports = o);
        },
        6518: function (t, e, n) {
          "use strict";
          ...
          t.exports = function (t, e) {
            var n,
              ...
              h = t.stat;
            if (
              ((u = w ? i : h ? i[f] || l(f, {}) : i[f] && i[f].prototype), u)
            )
              for (a in e) {
                if (
                  ((d = e[a]),
                  t.dontCallGetSet
                    ? ((p = o(u, a)), (L = p && p.value))
                    : (L = u[a]),
                  (n = s(w ? a : f + (h ? "." : "#") + a, t.forced)),
                  !n && void 0 !== L)
                ) {
                  if (typeof d == typeof L) continue;
                  c(d, L);
                }
                (t.sham || (L && L.sham)) && r(d, "sham", !0), C(u, a, d, t);
              }
          };
        },
        9039: function (t) {
        ...
        350: function (t, e, n) {
          ...
          var i = n(3724),
            ...
            s = l && (!i || (i && C(r, "name").configurable));
          t.exports = { EXISTS: l, PROPER: c, CONFIGURABLE: s };
        },
        7476: function (t, e, n) {
          "use strict";
          var i = n(2195),
        ...
        851: function (t, e, n) {
          ...
          var i = n(6955),
            ...
            c = l("iterator");
          t.exports = function (t) {
            if (!r(t)) return o(t, c) || o(t, "@@iterator") || C[i(t)];
          };
        },
        81: function (t, e, n) {
          "use strict";
          ...
          t.exports = function (t, e) {
            ...
            throw new c(C(t) + " is not iterable");
          };
        },
        5966: function (t, e, n) {
          "use strict";
        ...
        1181: function (t, e, n) {
          ...
          if (C || a.state) {
            var g = a.state || (a.state = new w());
            (g.get = g.get),
              (g.has = g.has),
              (g.set = g.set),
              (i = function (t, e) {
                if (g.has(t)) throw new f(p);
          ...
          t.exports = { set: i, get: o, has: r, enforce: h, getterFor: v };
        },
        4209: function (t, e, n) {
          "use strict";
          var i = n(8227),
            ...
            C = Array.prototype;
          t.exports = function (t) {
            return void 0 !== t && (o.Array === t || C[r] === t);
          };
        },
        4376: function (t, e, n) {
          "use strict";
        ...
        2652: function (t, e, n) {
          ...
          t.exports = function (t, e, n) {
            var w,
              ...
              k = i(e, _),
              E = function (t) {
                return w && L(w, "normal", t), new p(!0, t);
              },
              P = function (t) {
                return M
                  ? (r(t), O ? k(t[0], t[1], E) : k(t[0], t[1]))
                  : O
                  ? k(t, E)
                  : k(t);
              };
            if (b) w = t.iterator;
              ...
              if (((h = a(t)), !h)) throw new d(C(t) + " is not iterable");
              if (l(h)) {
                for (v = 0, g = c(t); g > v; v++)
                  if (((m = P(t[v])), m && s(f, m))) return m;
                return new p(!1);
              }
              w = u(t, h);
            }
            ...
            while (!(x = o(y, w)).done) {
              ...
              if ("object" == typeof m && m && s(f, m)) return m;
            }
            return new p(!1);
          };
        },
        ...
        9462: function (t, e, n) {
          ...
          var i = n(9565),
            ...
            w = c.set,
            h = function (t) {
              var e = c.getterFor(t ? f : p);
              return C(o(u), {
                next: function () {
                  var n = e(this);
                  if (t) return n.nextHandler();
                  try {
                    var i = n.done ? void 0 : n.nextHandler();
                    return a(i, n.done);
                  } catch (o) {
                    throw ((n.done = !0), o);
                  }
                ...
                return: function () {
                  ...
                  if (((n.done = !0), t)) {
                    var r = s(o, "return");
                    return r ? i(r, o) : a(void 0, !0);
                  }
                  if (n.inner)
                    try {
                      L(n.inner.iterator, "normal");
                    } catch (C) {
                      return L(o, "throw", C);
                    }
                  return o && L(o, "normal"), a(void 0, !0);
                },
              });
            },
            v = h(!0),
            g = h(!1);
          r(g, d, "Iterator Helper"),
            (t.exports = function (t, e) {
              var n = function (n, i) {
          ...
          var i = n(9565),
            ...
            s = l(function () {
              var t = this.iterator,
                e = r(i(this.next, t)),
                n = (this.done = !!e.done);
              if (!n) return c(t, this.mapper, [e.value, this.counter++], !0);
            });
          t.exports = function (t) {
            return r(this), o(t), new s(C(this), { mapper: t });
          };
        },
        7657: function (t, e, n) {
          "use strict";
          ...
          [].keys &&
            ((r = [].keys()),
            "next" in r
              ? ((o = u(u(r))), o !== Object.prototype && (i = o))
              : (f = !0));
          var w =
            !c(i) ||
            C(function () {
            ...
            m = (t.exports = function (t, e, n) {
              ...
              try {
                n && C(n, "constructor") && n.constructor
                  ? l && p(t, "prototype", { writable: !1 })
                  : t.prototype && (t.prototype = void 0);
              } catch (o) {}
              var i = a(t);
              return (
                C(i, "source") ||
                  (i.source = h(g, "string" == typeof e ? e : "")),
                t
              );
            });
          ...
          (l[f] = !0),
            (t.exports =
              ...
              function (t, e) {
                ...
                return (
                  null !== t
                    ? ((w[d] = o(t)), (n = new w()), (w[d] = null), (n[f] = t))
                    : (n = m()),
                  void 0 === e ? n : r.f(n, e)
                );
              });
        ...
        7347: function (t, e, n) {
          ...
          e.f = i
            ...
            : function (t, e) {
                ...
                if (s(t, e)) return C(!o(r.f, t, e), t[e]);
              };
        },
        8480: function (t, e, n) {
          "use strict";
        ...
        1828: function (t, e, n) {
          ...
          t.exports = function (t, e) {
            var n,
              ...
              s = 0,
              u = [];
            for (n in i) !o(l, n) && o(i, n) && c(u, n);
            while (e.length > s) o(i, (n = e[s++])) && (~C(u, n) || c(u, n));
            return u;
          };
        },
        1072: function (t, e, n) {
        ...
        4270: function (t, e, n) {
          ...
          t.exports = function (t, e) {
            var n, l;
            if ("string" === e && o((n = t.toString)) && !r((l = i(n, t))))
              return l;
            if (o((n = t.valueOf)) && !r((l = i(n, t)))) return l;
            if ("string" !== e && o((n = t.toString)) && !r((l = i(n, t))))
              return l;
        ...
        3392: function (t, e, n) {
          ...
          var i = n(9504),
            ...
            C = i((1).toString);
          t.exports = function (t) {
            return "Symbol(" + (void 0 === t ? "" : t) + ")_" + C(++o + r, 36);
          };
        },
        7040: function (t, e, n) {
          "use strict";
        ...
        8227: function (t, e, n) {
          ...
          var i = n(4576),
            ...
            s = i.Symbol,
            u = o("wks"),
            a = c ? s["for"] || s : (s && s.withoutSetter) || C;
          t.exports = function (t) {
            return (
              r(u, t) || (u[t] = l && r(s, t) ? s[t] : a("Symbol." + t)), u[t]
            );
          };
        },
        4114: function (t, e, n) {
              ...
              f
                ? s(p, t, {
                    ...
                    set: function (e) {
                      ...
                      L(this, t) ? (this[t] = e) : u(this, t, e);
                    },
                  })
                : (p[t] = e);
            };
          L(p, g) || M(g, v),
            (!x && L(p, h) && p[h] !== Object) || M(h, _),
            (_.prototype = p),
            i({ global: !0, constructor: !0, forced: x }, { Iterator: _ });
        },
        2489: function (t, e, n) {
          "use strict";
          var i = n(6518),
            ...
            a = c(function () {
              var t,
                ...
                l = this.next;
              while (1) {
                if (((t = C(o(l, i))), (e = this.done = !!t.done), e)) return;
                if (((n = t.value), s(i, r, [n, this.counter++], !0))) return n;
              }
            });
          i(
            ...
            {
              filter: function (t) {
                return C(this), r(t), new a(l(this), { predicate: t });
              },
            }
          );
        },
        ...
        1701: function (t, e, n) {
          ...
          var i = n(6518),
            o = n(713),
            r = n(6395);
          i({ target: "Iterator", proto: !0, real: !0, forced: r }, { map: o });
        },
        8992: function (t, e, n) {
          "use strict";
          n(8111);
    ...
    return (
      (function () {
        ...
        var o = function () {
            ...
            return e(
              "button",
              {
                ...
                class: [
                  t.type ? `w-button--${t.type}` : "",
                  t.size ? `w-button--${t.size}` : "",
                  t.disabled || t.loading || t.localLoading
                    ? "w-button--disabled"
                    : "",
                  t.icon ? "w-button--icon" : "",
                ],
                attrs: { disabled: t.disabled || t.loading || t.localLoading },
                on: { click: t.handleClick },
              },
              [
                t.loading || t.localLoading
                  ? e("w-svg-icon", {
                      staticClass: "w-button--loading",
                      attrs: { name: "line-loading", size: t.iconSize },
                    })
                  : t._e(),
                !t.icon || t.loading || t.localLoading
                  ? t._e()
                  : e("w-svg-icon", {
                      attrs: {
                        name: t.icon,
          ...
          C = function () {
            ...
            return e(
              ...
              [e("use", { attrs: { "xlink:href": t.symbolId } })]
            );
          },
          l = [],
          c = {
        ...
        var a = u(s, C, l, !1, null, null, null),
          L = a.exports,
          d = {
            name: "WButton",
            components: { WSvgIcon: L },
            props: {
              type: { type: String, default: "default" },
              size: { type: String, default: "medium" },
              disabled: { type: Boolean, default: !1 },
              loading: { type: Boolean, default: !1 },
              hasLoading: { type: Boolean, default: !1 },
              icon: { type: String, default: "" },
              iconStroke: { type: Boolean, default: !1 },
            },
            data() {
              return { localLoading: !1 };
            },
            computed: {
              iconClass() {
            ...
            methods: {
              async handleClick(t) {
                if (this.hasLoading)
                  try {
                    (this.localLoading = !0), await this.$listeners?.click(t);
                  } catch (e) {
                    console.log(e);
                  } finally {
                    this.localLoading = !1;
                  }
                else this.$emit("click", t);
              },
            },
          },
          p = d,
          f = u(p, o, r, !1, null, "00035ed5", null),
          w = f.exports;
        n(1454);
        ...
        var g = function () {
            ...
            return e(
              "div",
              {
                ...
                class: [
                  t.type ? `w-divider--${t.type}` : "",
                  t.direction ? `w-divider--${t.direction}` : "",
                  t.$slots.default ? "w-divider--text" : "",
                  t.orientation
                    ? `w-divider--orientation-${t.orientation}`
                    : "",
                ],
                style: { margin: t.marginStyle },
              },
              [
                t.$slots.default
                  ? e(
          ...
          x = y,
          _ = u(x, g, m, !1, null, "1720196c", null),
          M = _.exports,
          b = function () {
            var t = this,
              e = t._self._c;
            return e(
              "div",
              {
                staticClass: "w-card",
                class: [
                  t.title || t.$slots.header
                    ? "w-card--has-header"
                    : "w-card--no-header",
                  t.size ? `w-card--size-${t.size}` : "",
                  t.shadow ? `w-card--shadow-${t.shadow}` : "",
                ],
              },
              [
                t.title || t.$slots.header
                  ? e("div", { staticClass: "w-card-header" }, [
                      t.$slots.header
                        ? e(
                            "div",
                            { staticClass: "title" },
                      ...
                      t.$slots["sub-title"]
                        ...
                        : t._e(),
                      t.subTitle && !t.$slots["sub-title"]
                        ? e("div", { staticClass: "sub-title" }, [
                ...
                e(
                  "div",
                  {
                    ...
                    style: `padding-bottom: ${t.bottom}px`,
                  },
                  [t._t("default")],
                  2
                ),
          ...
          k = O,
          E = u(k, b, S, !1, null, "2cc328f2", null),
          P = E.exports,
          j = function () {
            var t = this,
              e = t._self._c;
            return e("div", { staticClass: "w-descriptions" }, [
              e("div", { staticClass: "w-descriptions__header" }, [
                e(
                  "div",
              ...
              e("div", { staticClass: "w-descriptions__body" }, [
                e(
                  "table",
                  { staticClass: "w-descriptions__table" },
                  t._l(t.rows, function (t, n) {
                    return e("w-descriptions-row", {
                      key: n,
                      attrs: { row: t },
                    });
                  }),
          ...
          Z =
            ...
            function () {
              ...
              return e(
                "tbody",
                [
                  "vertical" === t.wDescriptions.direction
                    ? [
                        e(
                          "tr",
                          { staticClass: "w-descriptions-row" },
                          t._l(t.processedRow, function (n, i) {
                            return e(
                              "th",
                              {
                                key: i,
          ...
          N = A,
          I = u(N, Z, T, !1, null, "b0a06cc8", null),
          $ = I.exports;
        let z = (t) => {
          let e = {};
        ...
        var R,
          ...
          U = {
            ...
            provide() {
              return { wDescriptions: this };
            },
            methods: {
              getRows() {
                console.log(this.$slots.default, "default");
                const t = (this.$slots.default || []).filter(
                  (t) =>
                    t.tag &&
                    t.componentOptions &&
                    "WDescriptionsItem" === t.componentOptions.Ctor.options.name
                );
                console.log(t, "children");
                const e = t.map((t) => ({
                  props: this.getOptionProps(t),
                  slots: this.getSlots(t),
                  vnode: t,
                }));
                console.log(e, "nodes");
                const n = [];
                ...
                return (
                  e.forEach((e, r) => {
                    const C = e.props?.span || 1;
                    if (r === t.length - 1)
                      return (
                        i.push(this.filledNode(e, C, o, !0)), void n.push(i)
                      );
                    C < o
                      ? ((o -= C), i.push(e))
                      : (i.push(this.filledNode(e, C, o)),
                        n.push(i),
                        (o = this.column),
                        (i = []));
                  }),
              ...
              getOptionProps(t) {
                if (!t.componentOptions) return {};
                const e = t.componentOptions,
                  { propsData: n = {}, Ctor: i = {} } = e,
                  o = (i.options || {}).props || {},
                  r = {};
                for (const C in o) {
                  const e = o[C],
                    n = e.default;
                  void 0 !== n && (r[C] = z(n) ? n.call(t) : n);
                }
                return { ...r, ...n };
              },
              getSlots(t) {
                console.log(t);
                let e = t.componentOptions || {};
                const n = t.children || e.children || [],
                  i = {};
                return (
                  n.forEach((t) => {
                    if (!this.isEmptyElement(t)) {
                      const e = (t.data && t.data.slot) || "default";
                      (i[e] = i[e] || []),
                        "template" === t.tag
                          ? i[e].push(t.children)
                          : i[e].push(t);
          ...
          F = U,
          W = u(F, j, B, !1, null, "0c9eac7b", null),
          G = W.exports,
          q = {
